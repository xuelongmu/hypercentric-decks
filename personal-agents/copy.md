...
- **Granola:** show messy meeting notes or transcript becoming source material.
- **Slack:** show the command/request surface and the current thread.
- **GitHub:** show `zerogen-os`, `AGENTS.md`, source-of-truth docs, and PR diff.
- **Linear:** show ZeroGen Agent / ZeroGen OS project hierarchy and issues.
- **Notion:** show the lightweight human-facing ZeroGen workspace.
